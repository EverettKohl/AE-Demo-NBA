...
const FormatBuilderPage = () => {
  ...
  const loadFormat = useCallback(async (song) => {
    ...
    try {
      const res = await fetch(`/api/format-builder/get?slug=${song.slug}`);
  ...
  const loadWaveform = useCallback(async (song) => {
    ...
    try {
      ...
      const savedRes = await fetch(`/api/format-builder/waveform/get?slug=${song.slug}`);
      if (savedRes.ok) {
      ...
      const res = await fetch("/api/format-builder/waveform", {
        method: "POST",
  ...
  const handleGenerateCaptions = useCallback(async () => {
    ...
    setCaptionsError(null);
    try {
      const res = await fetch("/api/format-builder/captions/generate", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSaveCaptionsOnly = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch("/api/format-builder/captions/save", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleRenderCaptions = useCallback(async () => {
    ...
    try {
      ...
      if (hasUnsavedChanges && format?.captions) {
        const saveRes = await fetch("/api/format-builder/captions/save", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ slug: selectedSong.slug, captions: format.captions }),
        });
      ...
      const res = await fetch("/api/format-builder/render", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ slug: selectedSong.slug }),
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/format-builder/save", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          slug: selectedSong.slug,
  ...
  const handleAutoAnalyze = async () => {
    ...
    try {
      const res = await fetch("/api/format-builder/analyze", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          songPath: selectedSong.path,
