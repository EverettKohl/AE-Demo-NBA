...
export function GenerateEditOverlay({ open, onClose }: Props) {
  ...
  const [chronological, setChronological] = React.useState(false);
          ...
          <div className={cn("w-full max-w-xl space-y-4 transition-opacity duration-75", isSeekAnimating && "opacity-0 pointer-events-none")}>
            <div className="rounded-lg border border-white/10 bg-white/5 p-4 space-y-2">
              ...
              <div className="flex items-center justify-between rounded-md border border-white/10 bg-white/5 px-3 py-2 text-sm">
                <span className="text-xs uppercase tracking-[0.2em] text-white/60">Chronologic order</span>
                <Button
                  variant="outline"
                  size="sm"
