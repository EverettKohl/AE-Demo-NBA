...
export const TimelineSection: React.FC<TimelineSectionProps> = () => {
  ...
  // Use the fps from context; fall back to 30 if undefined
  const effectiveFps = fps ?? 30;

  const { transformOverlaysToTracks, transformTracksToOverlays } = useTimelineTransforms(effectiveFps);
    ...
    <>
      ...
      >
        <Timeline
          ...
          totalDuration={frameToTime(durationInFrames, effectiveFps)} // Convert frames to seconds
