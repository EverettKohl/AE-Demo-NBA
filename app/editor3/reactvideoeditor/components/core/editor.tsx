...
export const Editor: React.FC<EditorProps> = ({
  ...
  return (
    ...
    >
      {/* Player shell (header + viewer) kept isolated so overlays can target it without affecting timeline */}
      <div id="player-shell" className="relative flex flex-col w-full flex-1 min-h-0">
        <EditorHeader 
