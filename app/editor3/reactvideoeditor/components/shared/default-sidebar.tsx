...
export const DefaultSidebar: React.FC<DefaultSidebarProps> = ({
  ...
  const navigationItems = [
    {
      title: getPanelTitle(OverlayType.SEARCH),
      url: "#",
      icon: Search,
      panel: OverlayType.SEARCH,
  ...
  // Shared styling for the icon rail buttons to keep them minimal + white
  const iconButtonClass =
    "text-white hover:text-white data-[active=true]:text-white hover:bg-transparent data-[active=true]:bg-transparent focus-visible:ring-1 focus-visible:ring-white/40 focus-visible:ring-offset-0";
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                size="lg"
                asChild
                className={`md:h-8 md:pb-4 md:pt-4 ${iconButtonClass}`}
              >
                <a href="#">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <SidebarMenuButton
                      ...
                      size="lg"
                      className={`flex flex-col items-center gap-2 px-1.5 py-2.5 ${iconButtonClass}`}
