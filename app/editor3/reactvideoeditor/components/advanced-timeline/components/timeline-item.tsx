...
export const TimelineItem: React.FC<TimelineItemProps> = ({ 
  ...
  const isPoster = Boolean((item as any)?.data?.isPoster);
  const isGraceBlock = Boolean((item as any)?.data?.isGraceBlock);
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    if (isPoster || isGraceBlock) return;
      ...
      <ContextMenuTrigger asChild>
        <div
          ...
          style={{
            ...
            userSelect: 'none',
            pointerEvents: isGraceBlock ? 'none' : 'auto',
