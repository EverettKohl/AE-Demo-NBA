...
export const SoundLayerContent: React.FC<SoundLayerContentProps> = ({
  ...
  // Calculate volume with fade in/out (respect track mute)
  const baseVolume = (overlay.styles?.volume ?? 1) * (trackMuted ? 0 : 1);
  ...
  // Html5Audio expects trimBefore in frames; startFromSound is already stored in frames.
  const trimBeforeFrames = typeof overlay.startFromSound === "number" ? overlay.startFromSound : 0;
