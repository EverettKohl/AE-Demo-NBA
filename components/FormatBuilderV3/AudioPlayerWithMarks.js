  ...
  return (
    <div className="bg-gray-900 border border-gray-700 rounded-xl p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="font-mono text-2xl text-amber-400 tracking-wider">
          {formatTimeDisplay(currentTime)}s
        </div>
        <div className="text-slate-400 text-sm">
          / {formatTimeDisplay(duration)}s
        </div>
      </div>
      ...
      <div
        ref={progressRef}
        className="relative h-3 bg-gray-800 rounded-full cursor-pointer overflow-hidden"
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={onAddMark}
          className="flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-semibold rounded-lg transition-all shadow-lg"
        >
      ...
      <div className="text-xs text-slate-500 flex items-center gap-4">
        <span><kbd className="px-1.5 py-0.5 bg-gray-800 rounded text-slate-400">Space</kbd> Play/Pause</span>
        <span><kbd className="px-1.5 py-0.5 bg-gray-800 rounded text-slate-400">M</kbd> Add Mark</span>
        <span><kbd className="px-1.5 py-0.5 bg-gray-800 rounded text-slate-400">←/→</kbd> Seek ±0.1s</span>
        <span><kbd className="px-1.5 py-0.5 bg-gray-800 rounded text-slate-400">Shift+←/→</kbd> Seek ±1s</span>
      </div>
    </div>
  );
};
